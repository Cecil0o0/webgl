module.exports = [
  ...
  { name: "line", title: "Magic Lines", entry: "src/pages/line" },
  { name: "triangle", title: "Triangles' World", entry: "src/pages/triangle" },
  {
  ...
  { name: "cone", title: "cone", entry: "src/pages/cone" },
  { name: "snowy", title: "snowy", entry: "src/pages/snowy" },
  {
    name: "strange-sphere",
    title: "strange-sphere",
    entry: "src/pages/strange-sphere"
  }
];
